...
export const mockCredentials: CredentialProvider[] = [
  { id: "gmail", group: "Correo", name: "Gmail", glyph: "GM", iconColor: "#EA4335", status: "disconnected", maskedKey: "sin Google conectado", lastTest: "requiere permiso Gmail" },
  { id: "whatsapp", group: "Correo", name: "WhatsApp / CallMeBot", glyph: "WA", iconColor: "#25D366", status: "disconnected", maskedKey: "sin WhatsApp conectado", lastTest: "requiere prueba" },
